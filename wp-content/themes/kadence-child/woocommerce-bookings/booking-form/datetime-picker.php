...
<div class="form-field form-field-wide">
	...
	?>
		<div class="block-picker wc-bookings-time-block-picker">
			<p><?php esc_html_e( 'Click a green date to see available times, then click a time to select it.', 'woocommerce-bookings' ); ?></p>
		</div>
		<input type="hidden" name="wc_bookings_field_duration" value="" class="wc_bookings_field_duration" />
	<?php } else { ?>
		<ul class="block-picker">
			<li><?php esc_html_e( 'Click a green date to see available times, then click a time to select it.', 'woocommerce-bookings' ); ?></li>
		</ul>
	<?php } ?>
